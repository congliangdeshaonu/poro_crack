...
ufile_pvd = File("poro_nonlinear_tension_1/displacement.pvd")
pfile_pvd = File("poro_nonlinear_tension_1/pressure.pvd")
crack_pvd = File ("poro_nonlinear_tension_1/crack.pvd")
...
while t<=1:
    ...
    while err > tol:
        ...
        err_phi = errornorm(d,d_n,norm_type = 'l2',mesh = None) #compute the error in d by comparing with the 
