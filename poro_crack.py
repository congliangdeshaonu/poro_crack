...
bc1 = DirichletBC(V.sub(0), Constant((0,0)), boundary_D)
...
ufile_pvd = File("poro_crack/displacement.pvd")
pfile_pvd = File("poro_crack/pressure.pvd")
crack_pvd = File ("poro_crack/crack.pvd")
